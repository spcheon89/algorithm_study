...
각 테스트 케이스마다 첫 번째 줄에 위 본문에서 설명한 대로 P, Q, R, S, W(1 ≤ P, Q, R, S, W ≤ 10000, 자연수)가
...
1) R이 W를 초과하는가 ? 초과하지 않으면 W * P와 Q 비교
2) R이 W를 초과할 경우 - W*P와 Q+S*(W-R) 비교
